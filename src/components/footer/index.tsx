      ...
      <FooterContent>
        <div className="col">
          ...
          <div className={'footerLogos'}>
            ...
            <a href="https://www.cushmanwakefield.com/" target={'_blank'}><img src={cwLogo} alt="Cushman & Wakefield"/></a>
          </div>
        </div>
        <div className="col">
        ...
        <div className="col">
          <div className="socials">
            <a href="#" target={'_blank'}><img src={iconFB} alt="facebook icon"/></a>
            <a href="#" target={'_blank'}><img src={iconInsta} alt="instagram icon"/></a>
            <a href="#" target={'_blank'}><img src={iconTw} alt="twitter icon"/></a>
            <a href="#" target={'_blank'}><img src={iconIn} alt="linkedIn icon"/></a>
          </div>
