  ...
  return (
    <HeaderWrap>
      <Nav className={'prim '} id={'hNav'}>
        <Link activeStyle={{opacity: 1}} to={'/'} className={"dark-color"}>BUILDING</Link>
        <Link activeStyle={{opacity: 1}} to={'/neighborhood'} className={"dark-color"}>NEIGHBORHOOD</Link>
        <Link activeStyle={{opacity: 1}} to={'/amenities'} className={"dark-color"}>AMENITIES</Link>
      </Nav>
      <Logo
        ref={headerLogo}
      ...
      <Nav className={'sec'} id={'sNav'}>
        <span onClick={() => setOpenTeam(true)} className={"dark-color"}>TEAM</span>
        <span onClick={() => setOpenContact(true)} className={"dark-color"}>CONTACT</span>
      </Nav>
