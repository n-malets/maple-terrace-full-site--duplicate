    ...
    return (
        <Wrapper ref={wrapperRef}>
            <FixedWrapper>
                ...
                <TeamInfo>
                    <h4 className={'h4 animation-style'} ref={title1}>{teamData.subHeading}</h4>
                    <h2 className={'h1 animation-style'} ref={title2}>{teamData.heading1}</h2>
                    <p className={'copy_t1 animation-style'} ref={description}>{teamData.copy}</p>
                    {teamData.quotation && (
