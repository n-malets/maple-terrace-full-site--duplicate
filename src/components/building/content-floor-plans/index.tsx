      ...
      .timeline({
        scrollTrigger: {
          ...
          onEnter: ()=> {
            ...
            fpImg1Ref.current!.style.opacity = '1';
            fpImg2Ref.current!.style.opacity = '0';
          },
          onEnterBack: ()=> {
            levelLabelsRef.current!.childNodes.forEach(el => el.classList.remove('active'))
            levelLabelsRef.current!.children[0].classList.add('active')
      ...
      .timeline({
        scrollTrigger: {
          ...
          onEnter: ()=> {
            ...
            fpImg1Ref.current!.style.opacity = '0';
            fpImg2Ref.current!.style.opacity = '1';
          },
          onEnterBack: ()=> {
            levelLabelsRef.current!.childNodes.forEach(el => el.classList.remove('active'))
            levelLabelsRef.current!.children[1].classList.add('active')
      ...
      .timeline({
        scrollTrigger: {
          ...
          onEnter: ()=> {
            ...
            fpImg3Ref.current!.style.opacity = '1';
            fpImg2Ref.current!.style.opacity = '0';
          },
          onEnterBack: ()=> {
            levelLabelsRef.current!.childNodes.forEach(el => el.classList.remove('active'))
    ...
    <FPWrapper>
      <FloorPlanImg ref={floorPlanImgRef}>
        <div className={"fp_images_wrapper"}>
          ...
          <img ref={fpImg1Ref} className={'fp_image_1'} src={FloorPlansData.floorPlan1.img} alt="Hines Maple-Terrace Floor-Plan L4"/>
          <img ref={fpImg2Ref} className={'fp_image_2'} src={FloorPlansData.floorPlan2.img} alt="Hines Maple-Terrace Floor-Plan L4"/>
          <img ref={fpImg3Ref} className={'fp_image_3'} src={FloorPlansData.floorPlan3.img} alt="Hines Maple-Terrace Floor-Plan L4"/>
