...
import { Wrapper, ScrollBtn } from "./index.styled"
...
const ContentPreload = () => {
  ...
  useEffect(() => {
    ScrollTrigger.create({
      ...
      animation: gsap
        .timeline()
        .fromTo(scrollBtnRefRef.current || "", { opacity: 1 }, { opacity: 0 })
        .fromTo("#hNav", { y: "-100px" }, { y: 0 }, "0")
        .fromTo("#sNav", { y: "-100px" }, { y: 0 }, "0")
        .fromTo("#hFooter", { top: "110vh" }, { top: "93vh" }, "0"),
    })
  }, [])
