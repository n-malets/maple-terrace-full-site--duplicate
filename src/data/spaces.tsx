...
export const spacesData = {
  spaces1: {
    ...
    heading1: (
      <>
        Stunning spaces open <br /> onto lush courtyards for <br /> events or
        socializing,
      </>
    ),
    heading2: (
      <>
        the new go-to spot for indoor <br /> or outdoor.
      </>
    ),
    copy: (
      <>
        Maple Terrace perfects the transition <br /> between cool interiors and
        open air <br /> with a cocktail lounge patio off the <br /> spacious
        enclosed bar, a glass living <br /> room covered in greenery, and an{" "}
        <br /> outdoor lounge under a canopy of trees <br /> and lanterns.
      </>
    ),
    reversed: false,
  },
  spaces2: {
    ...
    heading1: (
      <>
        The Maple & Ash experience <br /> can serve many moods when
      </>
    ),
    heading2: "you want to go somewhere special.",
    copy: (
      <>
        Whether celebrating your most momentous <br /> achievements or just
        catching up with friends, dining <br /> at The Maple & Ash can
        accommodate all tastes in a <br /> variety of settings.
      </>
    ),
    reversed: true,
  },
  spaces3: {
    ...
    heading1: (
      <>
        A private cocktail lounge <br /> for your clients,
      </>
    ),
    heading2: "a Special Retreat.",
    copy: (
      <>
        Your business can have its own private club in this <br /> penthouse bar
        with both indoor and outdoor seating. <br /> Perfect for events and
        meetings with a dash of privacy.
      </>
    ),
    reversed: false,
  },
